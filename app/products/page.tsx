          ...
          <section className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
            <div className="flex flex-col gap-4 max-w-2xl">
              ...
              <p className="text-[#1A1A1A]/60 dark:text-gray-400 text-lg md:text-xl font-normal leading-relaxed max-w-lg mt-2">
                Sustainably sourced ingredients, preserved at the peak of freshness. Explore our collection of premium pantry staples crafted for the modern table.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 w-full space-y-6">
            ...
            <div className="w-full">
              <label className="flex flex-col h-14 w-full">
                <div className="flex w-full flex-1 items-stretch rounded-lg h-full shadow-sm">
                  <div className="text-[#1A1A1A]/60 dark:text-gray-500 flex border-none bg-white dark:bg-[#1a2e22] items-center justify-center pl-4 rounded-l-lg border-r-0">
                    <span className="material-symbols-outlined text-[24px]">search</span>
                  </div>
                  <input
                    className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-r-lg text-[#1A1A1A] dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#13ec5b]/50 border-none bg-white dark:bg-[#1a2e22] h-full placeholder:text-[#1A1A1A]/40 dark:placeholder:text-gray-600 px-4 pl-2 text-base font-medium leading-normal transition-all"
                    placeholder="Search for heirloom tomatoes, sardines, spices..."
                    value={searchQuery}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex gap-3 overflow-x-auto hide-scroll pb-2 sm:pb-0">
                {categories.map((category) => (
                  <button
                    ...
                    className={`flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-full pl-5 pr-5 transition-colors ${
              ...
              <div className="flex items-center gap-2 text-sm">
                <span className="text-[#1A1A1A]/60 dark:text-gray-500">Sort by:</span>
              ...
              <div key={product.id} className="group flex flex-col gap-4 cursor-pointer">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className={`text-xs font-bold px-2 py-1 rounded-md ${
                        product.badgeStyle === "dark"
                          ? "bg-[#102216] text-white border border-gray-700"
                ...
                <div>
                  <div className="flex justify-between items-start mb-1">
                    <p className="text-[#1A1A1A] dark:text-white text-lg font-bold leading-tight group-hover:text-[#13ec5b] transition-colors">
                      {product.name}
                    </p>
                    <span className="text-[#1A1A1A] dark:text-gray-300 font-medium text-sm">{product.price}</span>
                  </div>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center text-sm font-bold text-[#1A1A1A] dark:text-white border-b-2 border-[#13ec5b]/20 hover:border-[#13ec5b] pb-0.5 transition-all"
                  >
                    View Details{" "}
